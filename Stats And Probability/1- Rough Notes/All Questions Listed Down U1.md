...
| ----------------- | --- | ---- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| No. of candidates | 7   | 10   | 16    | 32    | 24    | 18    | 10    | 5     | 1     |
...
| --------------- | --- | --- | --- | --- | --- | --- |
| No. of students | 10  | 20  | 30  | 40  | 50  | 30  |
* Calculate the Mean Deviation & coefficient of Mean Deviation from the following data:
...
* The first four moments of the distribution about the value 4 of the variable are -1.5, 17, -30, and 108. Find the moments about mean, and.
